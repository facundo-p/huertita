...
- Pedidos de los vecinos con fecha (#8, `datos/juego/pedidos.ts`). Pasados los primeros logros, algún vecino pide porciones de una especie para una fecha: la maestra de la escuela, Rosa, la pizzería, el comedor, doña Inés, la huerta comunitaria. El pedido no dice cuándo sembrar: eso se cuenta para atrás con la ficha. Se cumple cosechando lo pedido antes de la fecha y paga con sobres que no vienen en el arranque, compost maduro o un kit de riego por goteo (riega cada zona con un rato menos; el goteo estaba en el estado y nada lo daba). Solo llega un pedido que se puede cumplir en ese patio: entre que llega y la fecha hay una década ideal de siembra desde la que, en un año normal, se llega a cosechar. La cuenta usa el mismo modelo que el crecimiento (`decadasHastaCosecha`: la temperatura normal de cada década, la luz y el suelo del mejor lugar, el almácigo y el trasplante, y una huerta bien cuidada, `REGLAS.pedidos.cuidado`), porque fuera de su temperatura una especie tarda bastante más de lo que dice la ficha. Si vence, el cuaderno dice por qué (no sembraste, sembraste tarde, sembraste antes del límite pero en una época en que no llegaba, o no alcanzó) y hasta cuándo había que sembrar; si en esa época crece más lento que en la ficha, lo dice con las décadas que tarda. Un test juega los pedidos en serio: sembrando temprano se llega a la primera cosecha en la mayoría de los años, y sembrando una década después del límite casi nunca. Se ven arriba en el hud y en el panel de logros. Todas las filas y `REGLAS.pedidos` son [SUPUESTO].
  ...
  - El bot no los mira: en las 16 partidas del dorado llegan 32 pedidos y cumple 6 de 15 cerrados. El dorado se regeneró (otra vez cuando la cuenta pasó a usar el modelo de crecimiento: cambian las épocas y los plazos de la tabla, y con ellos qué pedidos llegan).
