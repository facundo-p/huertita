...
export const fondo: Patio = {
  ...
  bienvenida: 'Todavía hiela. El bancal elevado es el que más sol tiene ahora; la almaciguera está reparada. El tomate se arranca en almácigo protegido.',
  celdaM: 0.5,
  plano: [
    'PPPPPPPP',
    'ssssss:T',
  ...
  zonas: [
    { id: 'suelo', letra: 's', tipo: 'suelo', nombre: 'Bancal a suelo', conArticulo: 'el bancal a suelo', suelo: 'FRANCO_FERTIL', mo: 42, drenaje: 0, hondo: 60, riegoCosto: [0, 1, 2, 3], desc: 'Tierra del lugar, profunda y algo pesada. El paredón norte le saca sol en invierno.' },
